                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                echo '<img class="logoside" src="./upload/'.$data['logo2'].'"/>';
                            } else {
                                echo '<img class="logoside" src="./asset/img/logo2.png"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="smk-side">Dinas Pendidikan</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. KH. Ahmad Dahlan No. 75, Jetis Kec. Lamongan Kab. Lamongan</p>';
                            }
                        }
                    ?>
                </div>
